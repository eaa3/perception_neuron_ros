#ifndef _ROS_cob_msgs_BatteryServer2_h
#define _ROS_cob_msgs_BatteryServer2_h
...
#include "cob_msgs/BatteryState2.h"
...
namespace cob_msgs
{
  ...
  class BatteryServer2 : public ros::Msg
  {
    public:
      ...
      cob_msgs::BatteryState2 st_battery;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      if(battery_lengthT > battery_length)
        this->battery = (cob_msgs::BatteryState2*)realloc(this->battery, battery_lengthT * sizeof(cob_msgs::BatteryState2));
      offset += 3;
      battery_length = battery_lengthT;
      for( uint8_t i = 0; i < battery_length; i++){
      offset += this->st_battery.deserialize(inbuffer + offset);
        memcpy( &(this->battery[i]), &(this->st_battery), sizeof(cob_msgs::BatteryState2));
      }
     return offset;
    }

    const char * getType(){ return "cob_msgs/BatteryServer2"; };
